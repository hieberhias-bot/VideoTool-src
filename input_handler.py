...
class MouseIOHandler(InteractionHandlerInterface):
    ...
    def __init__(self, *args, **kwargs):
        """
        Initializes the MouseIOHandler class
        """

        self.serial_handler = IOHandler(*args, **kwargs)
        self.__logger = logging.getLogger("MouseIOHandler")
        self.__logger.info("MouseIOHandler Initialized")
