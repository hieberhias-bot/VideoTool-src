...
import time
import logging
from screen import GeneralCapture, WindowCapture
import cv2
from threading import Thread, Lock
from input_handler import MouseIOHandler, InteractionHandlerInterface, DirectInputHandler
...
class :
    ...
    def __init__(self, wnd_capture: WindowCapture, resize_factor: float, interaction_handler: InteractionHandlerInterface, debug=False, fast=False):
        ...
        self.__vision_processing = VisionProcessor(
...
def main():
    ...
    if args.use_arduino:
        mouse_keyboard_handler = MouseIOHandler(log_serial=args.debug)
    else:
